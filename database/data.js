const eduistData = [
  {
    ...
    death: 1961,
    summary:
      'Founder of analytical psychology; created some best known psychological concepts including the archetype, the collective unconscious, the complex, and the extraversion and introversion',
  },
  {
    ...
    death: 1952,
    summary:
      'Known for her philosophy of education called the Montessori method, it is still used in some public and private schools throughout the world',
  },
  {
    name: 'Benjamin Bloom',
    birth: 1913,
    death: 1999,
    summary:
      'Contributions to the classification of educational objectives and theory of mastery-learning',
  },
  {
    name: 'Robert Gagne',
    birth: 1916,
    death: 2002,
    summary:
      "Known for his 'Conditions of Learning' and computer based learning.",
  },
  {
    name: 'John Flavell',
    birth: 1928,
    death: -1,
    summary:
      "Flavell has conducted extensive research into metacognition and the child's theory of mind; most famous contribution is his work in children's development and understanding of the distinction between appearance and reality",
  },
  {
    name: 'Alfred Binet',
    birth: 1857,
    death: 1911,
    summary:
      'A french psychologist who invented the first practical intelligence test, the Binet-Simon Scale',
  },
  {
    name: 'Neil Flemming',
    birth: 1939,
    death: -1,
    summary:
      'New Zealand educator who is best known world-wide for the design of the VARK (Visual Aural Read/Write Kinesthetic model, which expanded upon earlier neuro-linguistic programming models.',
  },
  {
    name: 'Albert Bandura',
    birth: 1925,
  ...
  },
  {
    ...
    death: -1,
    summary:
      'An American psychologist that is listed among the 100 Most Eminent Psychologist of the 20th Century, and best known for his research on Cognitive Dissonance, High-Impact Experimentation, Jigsaw Classroom, and Gain-Loss Theory of Attraction.',
  },
  {
    name: 'Paulo Freire',
    birth: 1921,
    death: 1997,
    summary:
      'A brazilian educator and philosopher who was a leading advocate of critical pedagogy. He is best known for his influential work Pedagogy of the Oppressed which is considered one of the foundational texts of the critical pedagogy movement.',
  },
  {
    name: 'Lee Schulman',
    birth: 1938,
    death: -1,
    summary:
      'He is an educational psychologist who had made notable contributions to the study of teaching, assessment of teaching, and the fields of medicine, science, and mathematics. Schulman is credited with popularizing the phrase, Pedagogical Content Knowledge.',
  },
  {
    name: 'Ann Brown',
    birth: 1943,
  ...
  },
  {
    ...
    death: -1,
    summary:
      "Her work focuses on school restructuring, teacher education, and educational equity. Educational equity is a measure of achievement, fairness, and opportunity in education. She was also the educational advisor to Barack Obama's presidential campaign.",
  },
  {
    name: 'Seymour Papert',
    birth: 1928,
  ...
  },
  {
    ...
    death: 1994,
    summary:
      "Writer of 'Mastery Teaching' and her teaching model becomes widely used as teachers throughout the country attend her workshops and become 'Hunterized.'",
  },
  {
    name: 'B. F. Skinner',
    birth: 1904,
    death: 1990,
    summary:
      "Writer of 'Science and Human Behavior' in 1953. His form of behaviorism (operant conditioning), which emphasizes changes in behavior due to reinforcement, becomes widely accepted and influences many aspects of American education",
  },
  {
    ...
    death: 1827,
    summary:
      'Back death to death: nature concepts; started school at Neuhof and developed ideas of integrating of home life, vocational education, and education for reading and writing; and wrote Leonard and Gertrude, How Gertrude Teaches Her Children and Book for Mothers.',
  },
  {
    name: 'Ruby Bridges',
    birth: 1954,
    death: -1,
    summary:
      'First African American to attend William Frantz Elementary School in New Orleans in 1960. She became a class of one as parents remove all Caucasian students from the school.',
  },
  {
    name: 'Robert Owen',
    birth: 1771,
  ...
  },
  {
    ...
    death: 1849,
    summary:
      'Founder of the first college for women in the U.S. It opens in 1837 with 87 students',
  },
  {
    name: 'Jean Piaget',
    birth: 1896,
...
module.exports.data = eduistData;
